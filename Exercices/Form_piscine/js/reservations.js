            ...
            submitHandler: function (form) {
                ...
                $.post(
                    "./json/add_reservation.json.php",
                    {
                        ...
                        label_autre : $("#label_autre").val(),
                        moniteur_checked : $("#moniteur_check:checked").val(),
                        eleves:$("#eleves").val()
                    },
                    function(data){
                        console.log(data.type);
                            //data = ce qu'on a reçue comme réponse
                    ...
                    $(".message").html("Le formulaire n'a pas été envoyé");
                })
            }
